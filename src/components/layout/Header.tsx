...
//     return (
//         <header className="bg-gray-900 text-white py-6 px-10 md:px-28 shadow-lg">
...
//                 {/* Navigation */}
//                 <nav>
//                     <ul className="hidden md:flex gap-x-9 text-gray-300">
...
//                     >
//                         <span
//                             className="absolute -right-1 -top-1 rounded-full bg-red-500 h-5 w-5 text-white text-xs flex items-center justify-center animate-pulse"
//                         >
//                             {cartValue}
//                         </span>
...
//                     ☰ Menu
//                 </button>
//                 <ul className="hidden gap-y-3 text-gray-300 flex-col">
