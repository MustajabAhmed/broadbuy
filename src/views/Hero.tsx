...
const Hero = () => {
    return (
        <section className="relative bg-gradient-to-b from-gray-900 via-black to-gray-900 text-white pb-16 px-6 md:px-28 flex flex-col lg:flex-row items-center lg:gap-x-16">
            {/* Decorative Background Animations */}
            <div className="absolute inset-0 -z-10">
                <div className="absolute top-10 left-10 w-80 h-80 bg-gradient-to-br from-pink-500 via-purple-500 to-blue-500 rounded-full blur-[120px] animate-pulse"></div>
            ...
            <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left space-y-8">
                <Badge className="py-3 px-6 rounded-full bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 text-white font-medium tracking-widest uppercase shadow-lg animate-slide-in">
                    Trending Now
                </Badge>
                <h1 className="text-5xl md:text-6xl font-extrabold leading-tight animate-slide-in">
                    Redefine Your Style <br />
                ...
                <Button className="bg-gradient-to-r from-pink-500 via-purple-500 to-blue-500 text-white font-bold text-lg px-10 py-3 rounded-lg hover:shadow-xl transition-transform transform hover:scale-105 animate-bounce-in">
                    Start Shopping
                </Button>
            </div>
